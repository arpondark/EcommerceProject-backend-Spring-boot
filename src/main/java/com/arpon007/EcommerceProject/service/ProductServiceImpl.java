...
import com.arpon007.EcommerceProject.repositories.CategoryRepository;
...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductDTO addProduct(Long categoryId, ProductDTO productDTO) {
        ...
        if (isProductNotPresent) {
            ...
            // Handle null discount and price values
    ...
    public ProductDTO updateProduct(Long productId, ProductDTO productDTO) {
        ...
        // Recalculate special price when updating product
        Double discount = productFromDb.getDiscount() != null ? productFromDb.getDiscount() : 0.0;
        Double price = productFromDb.getPrice() != null ? productFromDb.getPrice() : 0.0;
